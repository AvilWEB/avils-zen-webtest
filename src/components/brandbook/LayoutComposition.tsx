        ...
        <div className="bg-card rounded-2xl p-8 border border-border">
          <div className="grid md:grid-cols-2 gap-6">
            <div className="relative">
              <img src={beforeDave} alt="Dave's Bathroom - Before" className="w-full aspect-[4/3] object-cover rounded-xl" />
              <span className="absolute top-4 left-4 bg-foreground/80 text-background px-3 py-1 rounded-full text-sm font-body">
                BEFORE
              </span>
            </div>
            <div className="relative">
              <img src={afterDave} alt="Dave's Bathroom - After" className="w-full aspect-[4/3] object-cover rounded-xl" />
        ...
        <div className="bg-card rounded-2xl p-8 border border-border">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="relative aspect-video rounded-xl overflow-hidden">
              {isVideoPlaying ? <video src="/testimonial-dave.mp4" autoPlay controls className="w-full h-full object-cover" /> : <>
                  <img src={testimonialDaveCover} alt="Dave's Testimonial" className="w-full h-full object-cover" />
                  <button onClick={() => setIsVideoPlaying(true)} className="absolute inset-0 flex items-center justify-center bg-foreground/20 hover:bg-foreground/30 transition-colors">
        ...
        <div className="bg-card rounded-2xl p-8 border border-border">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="aspect-video rounded-xl overflow-hidden">
              <video src="/videos/bathroom-dave.mp4" autoPlay loop muted playsInline className="w-full h-full object-cover" />
            </div>
            <div className="space-y-4">
