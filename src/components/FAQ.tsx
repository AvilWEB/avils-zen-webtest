...
const FAQ = () => {
  const faqs = [
    {
      question: "What does the $100 evaluation include?",
      answer:
    ...
    {
      question: "Is the $100 evaluation fee refundable?",
      answer:
        "The evaluation fee is non-refundable but represents a valuable first step. If you proceed with the full project, the $100 is credited toward your final invoice.",
    },
  ];
