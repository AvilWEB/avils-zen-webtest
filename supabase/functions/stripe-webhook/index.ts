...
const buildEmailHtml = (firstName: string) => `<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="x-apple-disable-message-reformatting"><meta name="color-scheme" content="light only"><meta name="supported-color-schemes" content="light only"><title>Payment received</title><style>:root{color-scheme:light only;supported-color-schemes:light only;}@media (prefers-color-scheme: dark){.bg-page{background-color:#E5E2D5 !important;}.bg-card{background-color:#fbfaf6 !important;}.text-dark{color:#131211 !important;}.text-mid{color:#2b2a26 !important;}.text-muted{color:#6b6a60 !important;}.text-footer{color:#85939E !important;}}[data-ogsc] .bg-page{background-color:#E5E2D5 !important;}[data-ogsc] .bg-card{background-color:#fbfaf6 !important;}[data-ogsc] .text-dark{color:#131211 !important;}[data-ogsc] .text-mid{color:#2b2a26 !important;}u+.body .bg-page{background-color:#E5E2D5 !important;}</style></head><body class="body" style="margin:0;padding:0;background-color:#E5E2D5 !important;"><table role="presentation" width="100%" cellpadding="0" cellspacing="0" class="bg-page" bgcolor="#E5E2D5" style="background-color:#E5E2D5 !important;"><tr><td align="center" style="padding:32px 16px;background-color:#E5E2D5 !important;" bgcolor="#E5E2D5"><table role="presentation" width="560" cellpadding="0" cellspacing="0" class="bg-page" bgcolor="#E5E2D5" style="max-width:560px;width:100%;background-color:#E5E2D5 !important;"><tr><td align="center" style="padding:24px 44px 0;"><img src="https://raw.githubusercontent.com/AvilWEB/avils-zen-webtest/main/public/logos/email-logo.png" alt="Avil&rsquo;s Bathrooms" width="260" style="display:block;margin:0 auto;max-width:260px;width:100%;height:auto;border:0;outline:none;text-decoration:none;" /><table role="presentation" cellpadding="0" cellspacing="0" style="margin:16px auto 0;"><tr><td style="width:40px;height:2px;background-color:#FFD700;font-size:0;line-height:0;">&nbsp;</td></tr></table></td></tr><tr><td align="center" style="padding:34px 44px 0;"><table role="presentation" cellpadding="0" cellspacing="0"><tr><td align="center" valign="middle" style="width:52px;height:52px;background-color:#8BAB1C !important;border-radius:26px;color:#ffffff !important;font-family:Arial,sans-serif;font-size:26px;line-height:52px;">&#10003;</td></tr></table><div class="text-dark" style="font-family:Georgia,serif;font-size:23px;color:#131211 !important;padding-top:18px;">Payment received</div></td></tr><tr><td align="center" class="text-mid" style="padding:20px 44px 0;font-family:Helvetica,Arial,sans-serif;font-size:15px;line-height:1.75;color:#2b2a26 !important;">Thank you, ${firstName}. We&rsquo;ve received your evaluation fee, and your project is now in our hands.</td></tr><tr><td style="padding:24px 44px 0;"><table role="presentation" width="100%" cellpadding="0" cellspacing="0" class="bg-card" bgcolor="#fbfaf6" style="background-color:#fbfaf6 !important;border:1px solid #d4d1c4;border-radius:8px;"><tr><td class="text-mid" style="padding:16px 18px;font-family:Helvetica,Arial,sans-serif;font-size:14px;line-height:1.6;color:#2b2a26 !important;">One of our designers will personally reach out <strong class="text-dark" style="color:#131211 !important;">within 48 hours</strong> to arrange your consultation.</td></tr></table></td></tr><tr><td style="padding:32px 44px 0;"><table role="presentation" width="100%" cellpadding="0" cellspacing="0"><tr><td style="height:1px;background-color:#FFD700;font-size:0;line-height:0;">&nbsp;</td></tr></table></td></tr><tr><td align="center" style="padding:24px 44px 32px;"><div class="text-muted" style="font-family:Georgia,serif;font-style:italic;font-size:14px;color:#6b6a60 !important;">Timeless, tactile, and deeply human.</div><div class="text-footer" style="font-family:Helvetica,Arial,sans-serif;font-size:12px;color:#85939E !important;padding-top:14px;line-height:1.7;">avilsbathrooms.com &middot; Bridgeport, CT<br>This confirms payment of your evaluation fee.</div></td></tr></table></td></tr></table></body></html>`;
